...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=arm64 --cc='xcrun -sdk appletvos clang -fembed-bitcode' --enable-cross-compile --enable-pic --disable-programs --disable-doc --disable-debug --disable-stripping --enable-static --disable-bzlib --disable-avfilter --disable-avdevice --disable-postproc --disable-encoders --disable-decoder=ac3 --disable-decoder=ac3_fixed --disable-decoder=eac3 --disable-decoder=mlp --enable-demuxers --enable-muxers --enable-openssl --extra-cflags=-I../../openSSL/include-tvos --extra-ldflags=-L../../openSSL/lib-tvos --disable-devices --disable-indevs --disable-outdevs --disable-filters --extra-cflags='-I../../include-tvos -arch arm64 -mtvos-version-min=9.0' --extra-ldflags='-L../../lib-tvos -arch arm64 -mtvos-version-min=9.0' --extra-cxxflags='-arch arm64 -mtvos-version-min=9.0' --prefix=/Users/muratsudan/Desktop/SDK_ALL/ALL_VIDEOSTREAMSDK/SRC/VK/VideoKit-TVOS/videokit/VideoKit/FFmpeg-Scripts/bin/AppleTVOS9.0-arm64.sdk"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2015
#define FFMPEG_DATADIR "/Users/muratsudan/Desktop/SDK_ALL/ALL_VIDEOSTREAMSDK/SRC/VK/VideoKit-TVOS/videokit/VideoKit/FFmpeg-Scripts/bin/AppleTVOS9.0-arm64.sdk/share/ffmpeg"
#define AVCONV_DATADIR "/Users/muratsudan/Desktop/SDK_ALL/ALL_VIDEOSTREAMSDK/SRC/VK/VideoKit-TVOS/videokit/VideoKit/FFmpeg-Scripts/bin/AppleTVOS9.0-arm64.sdk/share/ffmpeg"
